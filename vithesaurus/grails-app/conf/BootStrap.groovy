...
import com.vionto.vithesaurus.TermLinkType
import com.vionto.vithesaurus.ThesaurusUser
import com.vionto.vithesaurus.UserService;
...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        final String ADMIN_PASSWORD = userService.md5sum("admin")
